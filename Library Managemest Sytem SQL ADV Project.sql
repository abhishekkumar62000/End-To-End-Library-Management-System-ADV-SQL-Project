...
--WHERE member_id = 'C101'  and Set member_address = '125 Main St'.
...
-- Task 7. Retrieve All Books in a Specific Category:- WHERE category = 'Classic'

SELECT * FROM books
WHERE category = 'Classic'

    
-- Task 8: Find Total Rental Income by Category through Book:
...
VALUES
('C118', 'sam', '145 Main St', '2025-07-021'),
('C119', 'john', '133 Main St', '2025-06-01');
...
SELECT * FROM return_status
                    ...
                    -:Advance Question Interviews:-
      --:SQL Project - Library Management System ADV Query Section:--
